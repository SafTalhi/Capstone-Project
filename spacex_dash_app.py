...
def scatter(selected_site,payload):
    ...
    if selected_site=='ALL':
        ...
        fig=px.scatter(filtered_df[filtered_df['Launch Site']==selected_site],x='Payload Mass (kg)',y='class',color='Booster Version Category',title=f"Success count on Payload mass for site {entered_site}")
        return fig
